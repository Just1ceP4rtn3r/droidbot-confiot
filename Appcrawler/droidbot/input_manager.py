...
class InputManager(object):
    ...
    def __init__(
        ...
        self.policy = None
        self.script = None
        self.event_count = event_count if event_count is not None else DEFAULT_EVENT_COUNT
    ...
    def get_input_policy(self, device, app, master):
        ...
        elif self.policy_name == POLICY_AutodroidCrawlerPolicy:
            input_policy = AutodroidCrawlerPolicy(
                device, app, self.random_input, task=self.task
            )
        else:
